...
export const translations = {
  ...
  backToFarm: { en: '← Farm', tn: '← Letlole' },
  leave: { en: 'Leave', tn: 'Toka' },
  cancel: { en: 'Cancel', tn: 'Khansela' },
  confirm: { en: 'Confirm', tn: 'Netefatša' },
  close: { en: '✕', tn: '✕' },
  sold: { en: 'Sold!', tn: 'Etheletše!' },
  bought: { en: 'Bought!', tn: 'Rekile!' },

  // ---- Header ----
  farm: { en: 'Farm', tn: 'Letlole' },
  kgotla: { en: 'Kgotla', tn: 'Kgotla' },
  wild: { en: 'Wild', tn: 'Lefatshe' },
  market: { en: 'Market', tn: 'Ditshopa' },
  bag: { en: 'Bag', tn: 'Sesupu' },
  ...
  water: { en: '💧 Water', tn: '💧 Meya' },
  harvest: { en: '🌾 Harvest', tn: '🌾 Kotula' },
  waterAll: { en: 'Water All', tn: 'Meya Ka Moka' },
  harvestAll: { en: 'Harvest All', tn: 'Kotula Ka Moka' },
