...
> Implementation (2026-09-06): This Stitch screen maps to **Market**, not a Village scene. Live UI: React `MarketScreen`. Phaser `MarketScene` exists but is not registered.
